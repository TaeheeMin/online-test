					...
					<div class="row">
				                      	...
				                      	<form method="post" action="${pageContext.request.contextPath}/employee/addTeacher" id="addForm">
											...
											<div class="input-group input-group-static my-3">
										      <label>ID</label>
		  									  ...
		  									  <input type="text" class="form-control" name="teacherId" id="teacherId" readonly="readonly" placeholder="ID CHECK CLICK">
										    ...
										    <div class="text-end">
			                      				...
			                      				<a class="btn bg-gradient-dark mb-0 mt-3 px-3 mx-3" id="addBtn"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Teacher</a>
			                   				 </div>
										</form>
				                      </div>
				                    </div>
				                    <div class="text-end">
				                    <form method="get" action="${pageContext.request.contextPath}/employee/teacherList" id="serachForm">
										<select name="rowPerPage" id="rowPerPage">
											<option value="10">10
											<option value="20">20
											<option value="30">30
										</select>
										<input name="word" id="word" placeholder="강사 이름 검색" value="${word}">
							                  ...
							                  <c:forEach var="t" items="${list}">
							                    <tr>
						                          ...
						                          <td class="align-middle text-center">
							                       		<span class="text-secondary text-xs font-weight-bold">${t.teacherName}</span>
							                      </td>
							                      <td class="align-middle text-center">
				        ...
				        <!-- 페이징 -->
				          ...
				          <ul class="pagination pagination-primary pagination-sm justify-content-center">
				          	<li class="page-item">
						        <a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=${currentPage-1}&word=${word}" aria-label="Previous">
					        ...
					        <c:forEach var="i" begin="${beginPage}" end="${endPage}" step="1">
					        	<c:if test="${i == currentPage}">
									<li class="page-item active">
								      <a class="page-link" href="${pageContext.request.contextPath}/employee/teacherList?currentPage=${i}&word=${word}">${i}</a>
								    </li>
								</c:if>
					        	<c:if test="${i != currentPage}">
									<li class="page-item">
