						...
						<div class="row">
	                        ...
	                        <div class="col-xl-4 col-lg-5">
	                            <div class="card shadow mb-4">
	                                ...
	                                <div class="card-header py-3">
	                                    <h6 class="m-0 font-weight-bold text-primary">직원등록</h6>
	                                </div>
	                                <!-- Card Body -->
	                                <div class="card-body">
							                <!-- 직원등록 Form -->
							                  <form method="post" action="${pageContext.request.contextPath}/employee/addEmp" id="addForm">
							                    ...
							                    <div class="row mb-3">
							                      ...
							                      <div class="col-md-8 col-lg-9">
							                        <input type="text" class="form-control mt-6" name="empId" id="empId" readonly="readonly" placeholder="ID CHECK CLICK">
							                      </div>
							                    </div>
							                    ...
							                    <div class="row mb-3">
							                      ...
							                      <div class="col-md-8 col-lg-9">
							                        <input type="password" class="form-control" name="empPw" id="empPw" placeholder="비밀번호를 입력해주세요">
							                      </div>
							                    </div>
							                    ...
							                    <div class="text-center">
							                      ...
							                      <button type="button" class="btn btn-primary" id="addEmpBtn">등록</button>
							                    </div>
	                        ...
	                        <div class="col-xl-8 col-lg-7">
	                            ...
	                            <div class="card shadow mb-4">
	                                ...
	                                <div class="card-body">
                               			<form method="get" action="${pageContext.request.contextPath}/employee/empList" id="serachForm" class="mb-3">
		                                	<div class="row">
			                                	...
			                                	<div class="col-sm-6 col-md-6  ">
				                                	<div class="dataTables_filter d-sm-flex justify-content-end">
					                                	<label>
					                                		<input class="form-control form-control-sm" type="text" name="word" id="word" placeholder="사원 이름 검색" value="${word}">
					                                	</label>
							                  ...
							                  <tbody>
								                  <c:forEach var="e" items="${list}">
								                    <tr>
							                          ...
							                          <td>
						                          		<h6 class="mb-0 text-sm">${e.empName}</h6>
								                      </td>
								                      <td class="align-middle text-center">
							                      		<a href="${pageContext.request.contextPath}/employee/removeEmp?empNo=${e.empNo}" class="btn btn-danger btn-circle btn-sm" id="remove">
		                                ...
		                                <div class="dataTables_paginate paging_simple_numbers align-items-center justify-content-center" style="display: flex;" id="dataTable_paginate">
						                	<ul class="pagination">
								                <li class="paginate_button page-item previous ${currentPage == 1 ? "disabled" : "" }" id="dataTable_previous">
									                <a  class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=${currentPage-1}&word=${word}&rowPerPage=${rowPerPage}" >
									                	Previous
									                </a>
								              	</li>
							              	 	<c:forEach var="i" begin="${beginPage}" end="${endPage}" step="1">
									              	 <li class="paginate_button page-item ${currentPage == i ? "active" : "" }" id="dataTable_current">
									              		<a class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=${i}&word=${word}&rowPerPage=${rowPerPage}">${i}</a>
									              	</li>
												</c:forEach>
								              	<li class="paginate_button page-item next ${currentPage == lastPage ? "disabled" : "" }" id="dataTable_next">
									              	<a aria-controls="dataTable" class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=${currentPage+1}&word=${word}&rowPerPage=${rowPerPage}">
									              		Next
									              	</a>
								              	</li>
								           </ul>
